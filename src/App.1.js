      ...
      <div className="App">
          <nav className="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
            <div className="container">
              <a className="navbar-brand js-scroll-trigger" href="#page-top">Smart Flow</a>
              ...
              <div className="row h-100">
                <div className="col-lg-7 my-auto">
                  <div className="header-content mx-auto">
                    <h1 className="mb-5">SmartFlow Is a self-checkout app that allows you to upload your shopping list, get guided through the most efficient route, and checkout without having to touch a single line.</h1>
